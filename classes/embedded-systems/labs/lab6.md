...
8. Watch the assembly instruction video (https://www.youtube.com/watch?v=aJRYTqZu5OE) or follow the instructions given
here (https://learn.sparkfun.com/tutorials/assembly-guide-for-redbot-with-shadow-chassis) to assembly the chassis of your robot.
...
1. FreeRTOS Manual (https://www.freertos.org/FreeRTOS-quick-start-guide.html) (expand API Reference on the side for full documentation on function calls)
